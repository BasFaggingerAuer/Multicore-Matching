...
void GraphMatchingTBBRandom::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, std::vector<int> & lengthOfPath) const
{
...
void GraphMatchingTBBWeighted::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, std::vector<int> & lengthOfPath) const
{
