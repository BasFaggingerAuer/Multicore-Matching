...
void GraphMatchingCPURandom::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & h, vector<int> & t, vector<int> & fll) const
{
...
void GraphMatchingCPUMinDeg::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & h, vector<int> & t, vector<int> & fll) const
{
...
void GraphMatchingCPUStatMinDeg::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & h, vector<int> & t, vector<int> & fll) const
{
...
void GraphMatchingCPUKarpSipser::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & h, vector<int> & t, vector<int> & fll) const
{
...
void GraphMatchingCPUWeighted::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & h, vector<int> & t, vector<int> & fll) const
{
...
void GraphMatchingCPUWeightedEdge::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & h, vector<int> & t, vector<int> & fll) const
{
	//This is a greedy weighted matching algorithm.
