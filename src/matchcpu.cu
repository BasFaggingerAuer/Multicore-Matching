...
void GraphMatchingCPURandom::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, vector<int> & lengthOfPath, std::vector<int> & heads, std::vector<int> & tails) 
{
...
void GraphMatchingCPUMinDeg::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, vector<int> & lengthOfPath, std::vector<int> & heads, std::vector<int> & tails) 
{
...
void GraphMatchingCPUStatMinDeg::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, vector<int> & lengthOfPath, std::vector<int> & heads, std::vector<int> & tails) 
{
...
void GraphMatchingCPUKarpSipser::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, vector<int> & lengthOfPath, std::vector<int> & heads, std::vector<int> & tails) 
{
...
void GraphMatchingCPUWeighted::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, vector<int> & lengthOfPath, std::vector<int> & heads, std::vector<int> & tails) 
{
...
void GraphMatchingCPUWeightedEdge::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, vector<int> & lengthOfPath, std::vector<int> & heads, std::vector<int> & tails) 
{
	//This is a greedy weighted matching algorithm.
