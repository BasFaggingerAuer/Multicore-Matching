...
class GraphMatchingGPU : public GraphMatching
{
	public:
		...
		void writeGraphViz(uint * match, 
							thrust::device_vector<int> & fll, 
							thrust::device_vector<int> & bll, 
							thrust::device_vector<int> & heads, 
							std::vector<int> &, cudaEvent_t &, cudaEvent_t &);
