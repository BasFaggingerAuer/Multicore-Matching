...
class GraphMatchingGPURandom : public GraphMatchingGPU
{
	public:
		...
		void performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> &hfll, vector<int> &hheads, vector<int> &htails) const;
...
class GraphMatchingGeneralGPURandom : public GraphMatchingGPU
{
	public:
		...
		virtual void performMatching(std::vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, std::vector<int> &hfll, std::vector<int> &hheads, std::vector<int> &htails) const;
