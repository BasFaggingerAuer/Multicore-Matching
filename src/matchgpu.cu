...
void GraphMatchingGPURandom::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, vector<int> & lengthOfPath, std::vector<int> & heads, std::vector<int> & tails) 
{
...
void GraphMatchingGeneralGPURandom::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, vector<int> & lengthOfPath, std::vector<int> & heads, std::vector<int> & tails) 
{
	//Creates a greedy random matching on the GPU.
	//Assumes the current matching is empty.
...
void GraphMatchingGPURandomMaximal::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, vector<int> & lengthOfPath, std::vector<int> & heads, std::vector<int> & tails) 
{
...
void GraphMatchingGPUWeighted::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, vector<int> & lengthOfPath, std::vector<int> & heads, std::vector<int> & tails) 
{
...
void GraphMatchingGPUWeightedMaximal::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, vector<int> & lengthOfPath, std::vector<int> & heads, std::vector<int> & tails) 
{
	//Creates a greedy weighted matching on the GPU.
	//Assumes the current matching is empty.
