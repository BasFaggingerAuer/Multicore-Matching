...
void GraphMatchingGPURandom::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, std::vector<int> & lengthOfPath) const
{
...
void GraphMatchingGeneralGPURandom::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, std::vector<int> & lengthOfPath) const
{
	//Creates a greedy random matching on the GPU.
	//Assumes the current matching is empty.
...
void GraphMatchingGPURandomMaximal::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, std::vector<int> & lengthOfPath) const
{
...
void GraphMatchingGPUWeighted::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, std::vector<int> & lengthOfPath) const
{
...
void GraphMatchingGPUWeightedMaximal::performMatching(vector<int> &match, cudaEvent_t &t1, cudaEvent_t &t2, vector<int> & fll, vector<int> & bll, std::vector<int> & lengthOfPath) const
{
	//Creates a greedy weighted matching on the GPU.
	//Assumes the current matching is empty.
